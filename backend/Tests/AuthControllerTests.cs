...
public class AuthControllerTests : IDisposable
{
    ...
    public async Task Register_WithInvalidEmailFormat_Returns400BadRequest()
    {
        ...
        var fieldErrors = new Dictionary<string, string> { { "email", errorDetail } };
        _mockAuthService
            .Setup(s => s.RegisterUserAsync(request))
            .Returns(Task.FromResult((false, new RegisterResponse(), fieldErrors)));
    ...
    public async Task Register_WithPasswordMismatch_Returns400BadRequest()
    {
        ...
        var fieldErrors = new Dictionary<string, string> { { "confirmPassword", errorDetail } };
        _mockAuthService
            .Setup(s => s.RegisterUserAsync(request))
            .Returns(Task.FromResult((false, new RegisterResponse(), fieldErrors)));
    ...
    public async Task Register_WithPasswordLessThan8Chars_Returns400BadRequest()
    {
        ...
        var fieldErrors = new Dictionary<string, string> { { "password", errorDetail } };
        _mockAuthService
            .Setup(s => s.RegisterUserAsync(request))
            .Returns(Task.FromResult((false, new RegisterResponse(), fieldErrors)));
    ...
    public async Task Register_WithInvalidPhoneNumber_Returns400BadRequest()
    {
        ...
        var fieldErrors = new Dictionary<string, string> { { "phoneNumber", errorDetail } };
        _mockAuthService
            .Setup(s => s.RegisterUserAsync(request))
            .Returns(Task.FromResult((false, new RegisterResponse(), fieldErrors)));
    ...
    public async Task Register_Success_ResponseDoesNotIncludePasswordHash()
    {
        ...
        _mockAuthService
            .Setup(s => s.RegisterUserAsync(request))
            .Returns(Task.FromResult((true, expectedResponse, new Dictionary<string, string>())));
    ...
    public async Task Register_OnError_ResponseIncludesDetailField()
    {
        ...
        var fieldErrors = new Dictionary<string, string> { { "validation", errorDetail } };
        _mockAuthService
            .Setup(s => s.RegisterUserAsync(request))
            .Returns(Task.FromResult((false, new RegisterResponse(), fieldErrors)));
    ...
    public async Task Register_CallsAuthServiceRegisterUserAsync_WithCorrectPayload()
    {
        ...
        _mockAuthService
            .Setup(s => s.RegisterUserAsync(request))
            .Returns(Task.FromResult((true, mockResponse, new Dictionary<string, string>())));
    ...
    public async Task Register_WithMultipleErrors_ReturnsFirstError()
    {
        ...
        var errorDetail = "Name is required";
        var fieldErrors = new Dictionary<string, string> { { "name", errorDetail } };
        _mockAuthService
            .Setup(s => s.RegisterUserAsync(request))
            .Returns(Task.FromResult((false, new RegisterResponse(), fieldErrors)));
