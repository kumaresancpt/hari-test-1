        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FirstFailedLoginAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_session_tokens_users_UserId",
                        column: x => x.UserId,
                        principalTable: "users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_auth_audit_events_TimestampUtc",
                table: "auth_audit_events",
                column: "TimestampUtc");

            migrationBuilder.CreateIndex(
                name: "IX_auth_audit_events_Username",
                table: "auth_audit_events",
                column: "Username");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_session_tokens_TokenId",
