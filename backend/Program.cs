...
// EF Core — InMemory for testing (use PostgreSQL in production)
...
using (var scope = app.Services.CreateScope())
{
    ...
    // For relational databases (PostgreSQL), run migrations
    // For in-memory database, just ensure schema is created
